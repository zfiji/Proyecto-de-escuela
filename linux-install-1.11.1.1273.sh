...
curl -O https://download.clojure.org/install/clojure-tools-1.11.1.1273.tar.gz
tar xzf clojure-tools-1.11.1.1273.tar.gz
...
install -m644 clojure-tools/clojure-tools-1.11.1.1273.jar "$clojure_lib_dir/libexec/clojure-tools-1.11.1.1273.jar"
...
rm -rf clojure-tools
rm -rf clojure-tools-1.11.1.1273.tar.gz
